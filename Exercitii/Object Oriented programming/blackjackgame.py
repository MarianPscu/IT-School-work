...
# "eXER: CAND SE CREEAZA UN D NOU, SA SE INITIALIZEZE CELE 52 DE CARTI si treb puse in pachet, logic + get cards method return num cards - sa dea lista de carti si shuffle + apply magic methods to sort the cards"
